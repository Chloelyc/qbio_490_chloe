# change working directory and read the clinical data
knitr::opts_knit$set(root.dir = normalizePath("/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/analysis_data"))
clinical <- read.csv("/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/analysis_data/brca_clinical_data.csv")
...
jpeg(file="/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/histogram.jpg")
...
jpeg(file="/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/KM1.jpg")
KM_plot_percent
dev.off()
...
KM_plot_status = survplot_status$plot + 
  ...
  theme(axis.title = element_text(size=10), 
        ...
        legend.title = element_text(size=10),
        legend.text = element_text(size=7))
jpeg(file="/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/KM2.jpg")
KM_plot_status
dev.off()

# save all the figures and data
write.csv(percent_cleaned, "/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/analysis_data/percent_cleaned.csv", row.names = FALSE)
