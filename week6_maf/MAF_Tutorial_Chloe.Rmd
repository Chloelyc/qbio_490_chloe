...
# 1. Open jpeg file
jpeg("/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/week6_maf/20.jpg")
# 2. Create the plot
...
Yes. It can arrest growth by holding the cell cycle at the G1/S regulation point.
...
```{r}
oncoplot(maf = maf_object,
         genes = c("CCN4", "FAT4", "RAB7A", "TPO", "TNMD"))
```
...
1. Would frame shift lead to lower survival rate than point mutation?
2. Is there a common characteristic of the genes that have high mutation rate?
...
MAP3K1 gene mutation is mostly among old patients.
...
jpeg("/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/week6_maf/coOncoplot.jpg")
# 2. Create the plot
...
Hypothesized Reason: The TTN gene helps make titin, which is
important in movement of muscles. The muscle function of the elderly degrades. As TTN attempts to make more titin in order to promote muscle movement, it is prone to have more mutations in the process.
...
jpeg("/Users/chloelyc/Desktop/QBIO490/qbio_490_chloe/week6_maf/lollipop.jpg")
...
The amino acid at 180 is the most mutated, about 20 mutations.
...
```{r}
# write code here
# young_maf and old_maf already created
...
lollipopPlot2(m1 = young_maf, 
           ...
           gene = "TP53",
           m1_name = "young", 
           m2_name = "old") ## pick any gene of your choosing to fill in here
```
...
There are more mutations in P53, because it produces a protein that has a highly altered structure.

What kinds of mutations are the most common?
Missense mutation.

Are there any other interesting observations?
There is nearly no mutation in the P53_TAD region.
...
```{r}
maf_object@clinical.data$death_event <- ifelse(maf_object@clinical.data$death_event=="FALSE", F, T)
...
The number of mutant gene among the data set is 330 and that of normal gene is 634. 
The survival probability decreases more significantly for patients with TP53 mutant gene.

What can you conclude from your plot?
The survival rate of the BRCA with TP53 mutant gene is lower than that with normal gene.

Is this what you would expect according to the literature? Why or why not?
Yes. Because TP53 is a tumor suppressor gene which would lead to lower survival rate.
